...
{
    public abstract class UCompany.UProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UCompany.UProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UCompany.UProjectWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<UCompany.UProjectDbContext> action)
        {
            using (var context = IocManager.Resolve<UCompany.UProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<UCompany.UProjectDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<UCompany.UProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UCompany.UProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UCompany.UProjectDbContext, Task<T>> func)
        {
            T result;
